...
import com.example.guohouxiao.smartbutler.service.SmsService;
...
public class SettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void parsingJson(String t) {
        try {
            ...
            if (code > versionCode) {
                showUpdateDialog(jsonObject.getString("versionName"));
            } else {
